            ...
            <div class="d-flex align-items-center">
              ...
              <div>
                ...
                <div>
                  ...
                  <span class="m-2"><span class="icon-room mr-2"></span>{{$job->job_region_id}}</span>
                  <span class="m-2"><span class="icon-clock-o mr-2"></span><span class="text-primary">{{$job->created_at}}</span></span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-6">
                <form action="{{route('apply.job')}}" method="POST">
                    ...
                    @else
                      @if(Auth::check() && Auth::user()->cv == NULL)

                      <button type="" name="" class="btn btn-block btn-primary btn-md disabled">Upload Your Cv</button>
          ...
          <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            ...
            <div class="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
              <div class="job-listing-position custom-width w-50 mb-3 mb-sm-0">
                ...
                <strong>{{$rel_job->company}}</strong>
              </div>
              <div class="job-listing-location mb-3 mb-sm-0 custom-width w-25">
                <span class="icon-room"></span> {{$rel_job->job_region}}
              </div>

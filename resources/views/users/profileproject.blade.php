                    ...
                    <div class="row align-items-center">
                        <div class="col-md-3">
                            <div class="text-center border-end">
                                <img src="{{$profile->image}}" class="img-fluid avatar-xxl rounded-circle" alt="">
                                <h4 class="text-primary font-size-20 mt-3 mb-2">{{$profile->name}}</h4>
                                <h5 class="text-muted font-size-13 mb-0">--need to fill in table--</h5>
                            </div>
                        </div><!-- end col -->
                        <div class="col-md-9">
                            <div class="ms-3 row">
                                ...
                                <div class="row my-4">
                                    <div class="col-md-12">
                                        <div>
                                            <p class="text-muted mb-2 fw-medium"><i class="mdi mdi-email-outline me-2"></i>{{$profile->email}}</p>
                                            <p class="text-muted fw-medium mb-0"><i class="mdi mdi-phone-in-talk-outline me-2"></i>{{$profile->phone}}
                                            </p>
                                        </div>
                                    </div><!-- end col -->
                                </div><!-- end row -->
                            ...
                            <table class="table table-bordered mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>language fill need in table</td>
                                    </tr><!-- end tr -->
                                    <tr>
                                        <th scope="row">Website</th>
                                        <td>Need. to fill social link or portfolio</td>
                                    </tr><!-- end tr -->
                                </tbody><!-- end tbody -->
                            </table><!-- end table -->
                        </div>

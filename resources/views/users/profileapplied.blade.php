                    ...
                    <div class="col-md-9">
                        <div class="ms-3">
                            ...
                            <ul class="nav nav-tabs nav-tabs-custom border-bottom-0 mt-3 nav-justfied" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link px-4 "  href="{{route('profileSavedJob')}}" target="__blank">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link px-4 active" data-bs-toggle="tab" href="{{route('profileAppliedjob')}}" role="tab" aria-selected="false" tabindex="-1">
        ...
        <div class="card">
            <div class="tab-content p-4">
                ...
                <div class="tab-pane active show" id="tasks-tab" role="tabpanel">
                    <h4 class="card-title mb-4">Applied Jobs</h4>
                          ...
                          @if($applied_jobs->count() > 0) 
                            @foreach( $applied_jobs as $app_job)
                              <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                                <a href="{{route('single.job',$app_job->id)}}"></a>
                                <div class="job-listing-logo">
                                  <img src="{{$app_job->image}}" alt="Image" class="img-fluid">
                                </div>

                                <div class="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
                                  <div class="job-listing-position custom-width w-50 mb-3 mb-sm-0">
                                    <h5>{{$app_job->job_title}}</h>
                                    <strong>{{$app_job->company}}</strong>
                                  </div>
                                  <div class="job-listing-location mb-3 mb-sm-0 custom-width w-25">
                                    <span class="icon-room"></span> {{$app_job->job_region}}
                                  </div>
                                  <div class="job-listing-meta">
                                    <span class="badge badge-danger">{{$app_job->job_type}}</span>
                                  </div>
                                </div>
